...
public class SearchTasksByDateCommand extends Command{
    ...
    public static final String COMMAND_WORD = CommandEnum.SEARCH.toString().toLowerCase();

    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Searches for all deadline/events task occurring on a specific date. "
